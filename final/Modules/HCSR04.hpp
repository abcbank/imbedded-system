...
#define PIN_06 6
#define PIN_07 7
#define PIN_08 8        (therefore reducing time it takes for a single measurement).
     ...
     */
    UltraSonicDistanceSensor(byte triggerPin = TRIGGER, byte echoPin = ECHO, unsigned short maxDistanceCm = 400, unsigned long maxTimeoutMicroSec = 0);
